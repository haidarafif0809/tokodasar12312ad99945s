...
<span id="download" style="display: none;">
	<a href='download_lap_penjualan_rekap.php' type='submit' id="download_lap" target="blank" id="btn-download" class='btn btn-purple'><i class="fa fa-download"> </i> Download Excel</a>
</span>
</div> <!--/ container-->
