...
$sql = "SELECT p.id,p.no_faktur,p.total,p.tunai,p.suplier,p.tanggal,p.tanggal_jt,p.jam,p.user,p.status,p.potongan,p.tax,p.sisa,p.kredit,s.nama,g.nama_gudang, g.kode_gudang ";
