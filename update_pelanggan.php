...
$query = $db->prepare("UPDATE pelanggan SET kode_pelanggan = ?, nama_pelanggan = ?, no_telp = ?, e_mail = ?, tgl_lahir = ?, wilayah = ? , level_harga = ?, flafon = ? WHERE id = ?");

$query->bind_param("sssssssis",
	$kode_pelanggan, $nama_pelanggan, $no_telp, $e_mail, $tgl_lahir, $wilayah, $level_harga, $flafon, $id);
