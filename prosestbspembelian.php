  ...
  if ( $harga != $harga_baru) {
    ...
    $subtotal = $harga_beli * $jumlah_barang;
      ...
      else
      {
        ...
        echo "INSERT INTO tbs_pembelian (session_id,kode_barang,nama_barang,jumlah_barang,satuan,harga,subtotal,potongan,tax) VALUES ('$session_id', '$kode_barang', '$nama_barang', '$jumlah_barang', '$satuan', '$harga_beli', '$subtotaljadi', '$potongan_tampil', '$tax_persen')";
