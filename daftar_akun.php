...
// menampilkan seluruh data yang ada pada tabel penjualan yang terdapt pada DB
 $perintah = $db->query("SELECT * FROM daftar_akun ORDER BY kode_daftar_akun ASC");
...
// menampilkan seluruh data yang ada pada tabel penjualan yang terdapt pada DB
 $perintah = $db->query("SELECT * FROM daftar_akun WHERE kategori_akun = '$kategori' ORDER BY kode_daftar_akun ASC");
}
