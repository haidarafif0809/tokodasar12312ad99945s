...
$pilih_akses_otoritas = $db->query("SELECT hak_otoritas_hapus,hak_otoritas_edit FROM otoritas_master_data WHERE id_otoritas = '$_SESSION[otoritas_id]'  ");
$data_otoritas = mysqli_fetch_array($pilih_akses_otoritas);

    if ($data_otoritas['hak_otoritas_hapus'] > 0){
...
if ($data_otoritas['hak_otoritas_edit'] > 0){
