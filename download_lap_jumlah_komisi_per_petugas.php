...
header("Content-Disposition: attachment; filename=laporan_komisi_faktur_petugas.xls");
...
<hr>
 ...
 <table>
  <tbody>
    ...
    <h4 style="color: red"> Total Komisi / Faktur Dari <?php echo tanggal($dari_tanggal); ?> s/d <?php echo tanggal($sampai_tanggal); ?> : <b><?php echo rp($total_fee); ?></b></h4>
