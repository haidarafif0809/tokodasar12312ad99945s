...
$sql = "SELECT pel.nama_pelanggan,pel.kode_pelanggan,p.tunai,p.id,p.total,p.no_faktur,p.kode_pelanggan,p.tanggal,p.jam,p.user,p.status,p.potongan,p.tax,p.sisa ";
...
$sql = "SELECT pel.nama_pelanggan,pel.kode_pelanggan AS code_card,p.tunai,p.id,p.total,p.no_faktur,p.kode_pelanggan,p.tanggal,p.jam,p.user,p.status,p.potongan,p.tax,p.sisa ";
